...
Os Controllers são utilizados para lidar com a ligação da View com as outras partes do sistema 
...
@Table(name = "tb_usuario") -> Utilizamos esta anotação simplesmente para modificar o 
...
@JoinColumn -> Estamos avisando o JPA para criar uma coluna na tabela “tb_carro” com o 
nome “usuário_id”, onde terá o ID do usuário que o carro corresponde.
...
UsuarioController:
A anotação @RestController garante que minha classe seja um controlador REST 
...
Request 1 - GET: https://parallelum.com.br/fipe/api/v1/carros/marcas
Resposta 1 –
...
Request 2 - GET: https://parallelum.com.br/fipe/api/v1/carros/marcas/1/modelos
Resposta 2 –
